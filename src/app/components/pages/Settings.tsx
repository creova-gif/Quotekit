...
export default function Settings() {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 md:px-[30px] py-[26px]">
      <h1 className="text-[23px] tracking-[-0.4px] mb-5 text-[--qk-ink]" style={{ fontFamily: 'var(--qk-serif)' }}>Settings</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[210px_1fr] gap-[22px] items-start">
        ...
        <main className="bg-[--qk-s0] border border-[--qk-bdr] rounded-[14px] px-4 md:px-[22px] py-5">
          {activeSection === 'profile' && (
            <form onSubmit={handleSaveProfile}>
              <div className="mb-[22px] pb-[22px] border-b border-[--qk-bdr]">
                <h2 className="text-[14px] font-medium mb-[13px] text-[--qk-ink]">Profile information</h2>
                
                <div className="mb-[14px]">
                  <label htmlFor="full-name" className="block text-[13px] font-medium text-[--qk-ink] mb-[6px]">Full name</label>
                  <input
                    id="full-name"
                    type="text"
                    autoComplete="name"
                ...
                <div className="mb-[14px]">
                  <label htmlFor="email" className="block text-[13px] font-medium text-[--qk-ink] mb-[6px]">Email address</label>
                  <input
                    id="email"
                    type="email"
                    autoComplete="email"
                ...
                <div className="mb-[14px]">
                  <label htmlFor="company-name" className="block text-[13px] font-medium text-[--qk-ink] mb-[6px]">Company name</label>
                  <input
                    id="company-name"
                    type="text"
                ...
                <div className="mb-[14px] grid grid-cols-1 md:grid-cols-2 gap-4 max-w-[480px]">
                  <div>
                    <label htmlFor="country" className="block text-[13px] font-medium text-[--qk-ink] mb-[6px]">Country</label>
                    <select
                      id="country"
                  ...
                  {country === 'CA' && (
                    <div>
                      <label htmlFor="province" className="block text-[13px] font-medium text-[--qk-ink] mb-[6px]">Province / Territory</label>
                      <select
                        id="province"
                        value={province}
                ...
                <div className="mb-[14px]">
                  <label htmlFor="timezone" className="block text-[13px] font-medium text-[--qk-ink] mb-[6px]">Timezone</label>
                  <select
                    id="timezone"
                    value={timezone}
              ...
              <div className="mb-[22px] pb-[22px] border-b border-[--qk-bdr]">
                <h2 className="text-[14px] font-medium mb-[13px] text-[--qk-ink]">Preferences</h2>
                <SettingRow
                  id="email-notif"
                  label="Email notifications"
                  sublabel="Receive email updates for activity"
                  checked={emailNotifications}
                  onCheckedChange={setEmailNotifications}
                />
                <SettingRow
                  id="auto-save"
                  label="Auto-save proposals"
                  sublabel="Save drafts automatically"
                ...
                <SettingRow
                  ...
                  sublabel="Display helpful tooltips"
          ...
          {activeSection === 'branding' && (
            <>
              <div className="mb-[22px] pb-[22px] border-b border-[--qk-bdr]">
                <h2 className="text-[14px] font-medium mb-[13px] text-[--qk-ink]">Brand colors</h2>
              ...
              <div className="mb-[22px] pb-[22px] border-b border-[--qk-bdr]">
                <h2 className="text-[14px] font-medium mb-[13px] text-[--qk-ink]">Logo</h2>
                <button className="px-3 py-[6px] rounded-[10px] border border-[--qk-bdr] bg-transparent text-[--qk-ink2] text-[13px] hover:bg-[--qk-s1] hover:text-[--qk-ink] focus-visible:ring-2 focus-visible:ring-[--qk-blue] outline-none transition-all cursor-pointer" onClick={() => toast.info('Upload logo')}>
                  Upload logo
                </button>
              </div>

              <button className="px-3 py-[6px] rounded-[10px] bg-[--qk-blue] border border-[--qk-blue] text-white text-[13px] font-medium hover:bg-[--qk-blue-d] focus-visible:ring-2 focus-visible:ring-[--qk-blue] outline-none transition-all cursor-pointer" onClick={() => toast.success('Branding updated')}>
                Save branding
              </button>
            </>
          )}
          ...
          {activeSection === 'integrations' && (
            <>
              <h2 className="text-[14px] font-medium mb-[13px] text-[--qk-ink]">Connected services</h2>
              {[
          ...
          {activeSection === 'billing' && (
            <>
              <div className="mb-[22px] pb-[22px] border-b border-[--qk-bdr]">
                <h2 className="text-[14px] font-medium mb-[13px] text-[--qk-ink]">Current plan</h2>
                <div className="bg-[--qk-blue-l] border border-[--qk-blue-m] rounded-[14px] px-4 py-3 mb-3">
                  <div className="text-[15px] font-medium text-[--qk-blue] capitalize">{profile?.plan || 'Starter'} Plan</div>
                  <div className="text-[12px] text-[--qk-blue] mt-1">
                    {profile?.subscription_status === 'trialing' 
                      ? `Trialing · Ends ${profile?.trial_ends_at ? new Date(profile.trial_ends_at).toLocaleDateString() : 'soon'}`
                ...
                {profile?.plan !== 'business' && (
                  <button className="px-3 py-[6px] rounded-[10px] border border-[--qk-bdr] bg-transparent text-[--qk-ink2] text-[13px] font-medium hover:bg-[--qk-s1] hover:text-[--qk-ink] focus-visible:ring-2 focus-visible:ring-[--qk-blue] outline-none transition-all cursor-pointer" onClick={() => toast.info('Upgrade requests are processed via billing integration')}>
                    Upgrade Plan
                  </button>
                )}
              </div>

              <h2 className="text-[14px] font-medium mb-[13px] text-[--qk-ink]">Payment method</h2>
              <div className="bg-[--qk-s1] border border-[--qk-bdr] rounded-[10px] px-4 py-3 flex items-center justify-between">
                ...
                <button className="px-3 py-[6px] rounded-[10px] border border-[--qk-bdr] bg-transparent text-[--qk-ink2] text-[13px] font-medium hover:bg-[--qk-s1] hover:text-[--qk-ink] focus-visible:ring-2 focus-visible:ring-[--qk-blue] outline-none transition-all cursor-pointer" onClick={() => toast.info('Card update form')}>
                  Update
                </button>
              </div>
            </>
          ...
          {activeSection === 'notifications' && (
            <>
              <h2 className="text-[14px] font-medium mb-[13px] text-[--qk-ink]">Email alerts & notifications</h2>
              <div className="space-y-4">
                <SettingRow id="nt-opened" label="Proposal opened" sublabel="When a client opens your proposal" checked={notifyOpened} onCheckedChange={setNotifyOpened} />
                <SettingRow id="nt-accepted" label="Proposal accepted" sublabel="When a client accepts your proposal" checked={notifyAccepted} onCheckedChange={setNotifyAccepted} />
                <SettingRow id="nt-payment" label="Payment received" sublabel="When you receive a payment" checked={notifyPayment} onCheckedChange={setNotifyPayment} />
                <SettingRow id="nt-msg" label="New message" sublabel="When a client sends you a message" checked={notifyMessage} onCheckedChange={setNotifyMessage} />
                <SettingRow id="nt-summary" label="Weekly summary" sublabel="Weekly activity report" checked={notifySummary} onCheckedChange={setNotifySummary} />
                <SettingRow id="nt-marketing" label="Marketing emails" sublabel="Product updates and tips" checked={notifyMarketing} onCheckedChange={setNotifyMarketing} />
              </div>

              <button className="mt-6 px-3 py-[6px] rounded-[10px] bg-[--qk-blue] border border-[--qk-blue] text-white text-[13px] font-medium hover:bg-[--qk-blue-d] focus-visible:ring-2 focus-visible:ring-[--qk-blue] outline-none transition-all cursor-pointer" onClick={() => toast.success('Notification preferences saved!')}>
                Save preferences
              </button>
            </>
          )}
